          ...
          <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-[600px]">
                AudiBook makes it easy to reserve the best seats for all your favorite college events, performances, and
                conferences.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-background rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Book your preferred seats with just a few clicks. Our intuitive interface makes the booking process
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Multiple payment options with secure transaction processing. Your financial information is always
                protected.
              </p>
            </div>
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Easily book multiple seats together for friends and groups. Keep everyone together during events.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container px-4">
          <div className="relative overflow-hidden rounded-xl bg-primary text-primary-foreground p-8 md:p-12">
            <div className="absolute top-0 right-0 -mt-16 -mr-16 h-64 w-64 rounded-full bg-primary-foreground/10 blur-3xl"></div>
            <div className="absolute bottom-0 left-0 -mb-16 -ml-16 h-64 w-64 rounded-full bg-primary-foreground/10 blur-3xl"></div>

            <div className="relative z-10 max-w-2xl">
              <h2 className="text-3xl font-bold tracking-tight mb-4">Ready to Book Your Seats?</h2>
              <p className="text-primary-foreground/80 mb-6 text-lg">
                Don't miss out on the best events happening at your college. Book your seats now and secure your spot!
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
